/*----------------------------------------------------------------------------
	Program : shsCountries.h
	Author  : Silver Hammer Software LLC
	Author  : Tom Stevelt
	Date    : Sep 2022
	Synopsis: Country names and codes.  https://www.iban.com/country-codes
...
#define		COUNTRY_BY_NAME		1
#define		COUNTRY_BY_ALPHA2	2
#define		COUNTRY_BY_ALPHA3	3
#define		COUNTRY_BY_ISO		4
...
int					CountryCount = sizeof(CountryArray) / sizeof(COUNTRY_RECORD);

#else

extern	COUNTRY_RECORD		CountryArray[];
